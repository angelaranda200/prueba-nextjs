...
const Experiencia = () => {
  ...
  const agregarExperiencia = () => {
    ...
    const { empresa, cargo, fechaIngreso, fechaSalida, actualmenteTrabajando } =
      nuevaExperiencia;
    ...
    if (
      ...
      cargo === "" ||
      fechaIngreso === "" ||
      (fechaSalida === "" && !actualmenteTrabajando)
    ) {
    ...
    if (e && e.target) {
      ...
      const updatedValue =
        name === "actualmenteTrabajando"
          ? checked
          : nuevaExperiencia.actualmenteTrabajando;
  ...
  return (
    <div>
      ...
      >
        <Typography variant="h6" hidden={{ xs: true }}>
          Experiencias
        </Typography>
      ...
      <ModalFlotante isOpen={modalAbierto} onClose={cerrarModal}>
        ...
        <Button type="button" onClick={agregarExperiencia} variant="contained">
          Contained
        </Button>
      </ModalFlotante>
      ...
      <Box mt={3} p={2}>
        {experiencias.map((experiencia, index) => (
          ...
          >
            ...
            <Typography variant="h6" fontSize={20} color="rgba(0, 0, 24, 0.60)">
              {experiencia.cargo}
            </Typography>
